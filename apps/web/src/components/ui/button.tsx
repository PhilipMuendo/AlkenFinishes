...
export const buttonVariants = cva(
  `inline-flex items-center justify-center gap-2 rounded-lg font-medium transition-all duration-150 ${focusRing} active:scale-[0.98] disabled:pointer-events-none disabled:opacity-50`,
  {
    variants: {
      variant: {
